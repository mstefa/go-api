...
var ErrInvalidCourseID = errors.New("Invalid Couser ID")

// Course ID represent the course unique identifier (value object)
...
//CourseRepository devine the expected behaviour from a cousr storage
